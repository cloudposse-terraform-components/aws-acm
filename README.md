...
| <a name="input_certificate_export"></a> [certificate\_export](#input\_certificate\_export) | Whether to request an exportable public certificate or not | `bool` | `false` | no |
